<div x-data="{ open: false }" @open-modal.window="if ($event.detail === '{{ $modalId }}') open = true"
            ...
            <div @click.away="open = false"
                ...
                <div
                    ...
                    <button @click="open = false" type="button"
                        class="absolute top-1/2 p-2 text-gray-400 rounded-lg transition-colors -translate-y-1/2 hover:text-gray-600 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-300"
                ...
                <form action="{{ $action }}" method="POST">
                    ...
                    <div class="px-5 py-4 space-y-4">
                        ...
                        <div class="my-2 space-y-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="role" required value="{{ $testimonial->role ?? '' }}"
                                    class="py-2 pr-3 pl-9 w-full text-sm text-right text-gray-900 bg-gray-50 rounded-lg border border-gray-200 transition-all focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 dark:bg-gray-800/50 dark:border-gray-700 dark:text-white placeholder:text-gray-400"
                                ...
                                <div class="relative">
                                    ...
                                    <select name="color"
                                        ...
                                        <option value="primary"
                                            {{ ($testimonial->color ?? 'primary') == 'primary' ? 'selected' : '' }}>
                                            الأساسي</option>
                                        <option value="green-500"
                                            {{ ($testimonial->color ?? '') == 'green-500' ? 'selected' : '' }}>أخضر
                                        </option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="my-2 space-y-1">
                            ...
                            <textarea name="text" rows="3" required
                                ...
                                placeholder="ماذا قال العميل عن تجربته؟">{{ $testimonial->text ?? '' }}</textarea>
                        </div>

                        {{-- Active Toggle --}}
                        <div x-data="{ active: {{ $testimonial->active ?? true ? 'true' : 'false' }} }"
                    ...
                    <div
                        ...
                        <button type="submit"
                            class="inline-flex gap-2 items-center px-4 py-2 text-xs font-medium text-white bg-brand-500 rounded-lg hover:bg-brand-600 focus:ring-2 focus:ring-brand-500/50 transition-all shadow-sm hover:shadow-md active:scale-[0.98]">
