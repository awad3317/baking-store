<div x-data="{ showDeleteModal: false, deleteAction: '' }"
    x-on:open-delete-modal.window="showDeleteModal = true; deleteAction = $event.detail.action" x-show="showDeleteModal"
    class="fixed inset-0 flex items-center justify-center p-5 z-[99999]" style="display: none;">
    <div class="fixed inset-0 h-full w-full bg-gray-900/50 backdrop-blur-[32px]" @click="showDeleteModal = false"></div>
    ...
    <div class="relative w-full max-w-md rounded-2xl bg-white p-6 dark:bg-gray-900 shadow-xl">
        <div class="text-center py-4">
            <div class="relative flex items-center justify-center z-1 mb-7">
                <svg style="color:#fef3c7" width="90" height="90" viewBox="0 0 90 90" fill="none"
                ...
                <span class="absolute -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2">
                    <svg class="text-warning-600" width="38" height="38" viewBox="0 0 38 38" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="flex justify-center mt-6 gap-3">
                ...
                <form :action="deleteAction" method="POST" class="inline">
                    ...
                    @method('DELETE')
                    <button type="submit"
                        class="px-6 py-2 text-sm font-medium text-warning-500 rounded-lg bg-warning-500/[0.08] hover:bg-warning-500 hover:text-white transition-colors duration-200">
