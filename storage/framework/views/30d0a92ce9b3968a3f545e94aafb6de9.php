    ...
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div
            ...
            <a href="index.html" class="lg:hidden w-12 h-12">
                <img class="dark:hidden " src="<?php echo e(asset('tailadmin/build/src/images/user/Busat.png')); ?>"
                    alt="Logo" />
        ...
        <div :class="menuToggle ? 'flex' : 'hidden'"
            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                ...
                <div x-show="dropdownOpen"
                    class="shadow-theme-lg dark:bg-gray-dark absolute <?php echo e(app()->getLocale() == 'ar' ? 'left-0' : 'right-0'); ?> mt-[17px] flex w-[260px] flex-col rounded-2xl border border-gray-200 bg-white p-3 dark:border-gray-800">
                    <div>
...
<?php /**PATH E:\projects_2026\baking-store\resources\views/dashboard/layouts/header.blade.php ENDPATH**/ ?>